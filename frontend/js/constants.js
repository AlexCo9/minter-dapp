const contractAddress = "0x97E3f4989E54c149fdD7b19d978acCBf3B226807"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to The Katalysts NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'A grass-roots climate-obsessed community investing in climate solutions.';
...
const p_presale_mint_not_whitelisted = "You are not whitelisted for the pre-sale.. 😢 register here to get listed www.katalyst.earth ";
...
const p_public_mint = "No whitelist needed. Public minting is now open! 🎉 55-Minted";
...
const button_presale_already_minted = "Join the Katalyst Collective";
